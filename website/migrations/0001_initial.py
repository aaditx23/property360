...
>>>>>>> f7c0fc530cc40c7a6f558cd9d5cbf08fce231180
...
<<<<<<< HEAD
        migrations.CreateModel(
            name='Hires',
            fields=[
                ('support_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='website.support')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='website.user')),
            ],
            options={
